...
This repository contains five core datasets used to drive the Spatial Decision Support System (SDSS) for Worcester, MA. These files allow the system to calculate market share probabilities using the Huff Gravity Model and provide demographic context for retail site selection.
